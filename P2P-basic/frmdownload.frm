...
lvDL.ListItems(currIndex).ListSubItems(2).Text = "다운로드가 중단되었습니다."
...
lvDL.ListItems(lvDL.SelectedItem.Index).ListSubItems(2).Text = "다운로드 완료!"
...
If lvDL.SelectedItem.SmallIcon = 1 Then
    If MsgBox("다운로드를 중단합니다." & vbCrLf & "계속 하겠습니까?", vbQuestion + vbYesNo) = vbYes Then
        Command1_Click
