   ...
   Begin MSComctlLib.ImageList imgFiles 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":C7A8
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":EB2A
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Sub lvFiles_Click()
    ...
    For i = 1 To frmPlay.lvPlays.ListItems.Count
        If frmPlay.lvPlays.ListItems(i).Text = lvFiles.SelectedItem.Text Then
            MsgBox "Already you choose.", vbInformation, "Duplicate File"
            Exit Sub
        End If
    Next
...
Private Sub Form_Load()
    ...
    If App.PrevInstance = True Then
        MsgBox "P2P is already executing.", vbExclamation, "Inform"
        End
    End If
    ...
    Else
        Dim ret
        Me.Show
        ret = BrowseForFolder(Me.hwnd, "Select Share Directory .")
